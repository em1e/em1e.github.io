...
function executeCommand(command) {
    ...
    switch (cmd) {
        ...
        case "about":
            ...
            addLine("");
            addLine("I'm a 21 yo Jr. Software Developer still trying to find their true passion; someone who's typically quite learning-oriented, detail-focused, and always full of creative ideas. Currently, I'm working on my last projects at Hive, which I should be done by mid-spring 2025. In my free time I enjoy swimming, cooking, reading, as well as doing anything creative. I love picking up skills, networking, and spending time with my friends playing games. In other words, I'm your typical nerd just hidden in a shell that you might not see through at the first glance.");
